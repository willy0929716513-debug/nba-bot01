...
# ==========================================
# NBA V420 Sharp Syndicate - Market Value Filter Relaxed
# ==========================================
...
def run():
        ...
        for b in g.get("bookmakers", []):
            for m in b["markets"]:
                ...
                for o in m["outcomes"]:
                    ...
                    pace = PACE.get(o["name"], 100)
                    # 使用標準差計算勝率
                    prob = 1 - normal_cdf(0, clv, 11.5 + pace*0.05)
                    ev = prob*(o["price"]-1)-(1-prob)

                    # 過濾條件：EV >= MIN_EV_THRESHOLD 且 CLV >= MIN_CLV
    ...
    if not output_list:
        print("目前沒有符合 EV>=0.15 且 CLV>=0 的場次。")
        return
