...
INITIAL_POWER = {
    ...
    "New York Knicks": {"Net": 4.5, "Def": True},
    "Milwaukee Bucks": {"Net": 2.8, "Def": False},
    "Orlando Magic": {"Net": 3.8, "Def": True},
    "Indiana Pacers": {"Net": -0.5, "Def": False},
    "Philadelphia 76ers": {"Net": 1.2, "Def": False},
    "Miami Heat": {"Net": 1.5, "Def": True},
    "Atlanta Hawks": {"Net": -1.8, "Def": False},
    "Brooklyn Nets": {"Net": -3.5, "Def": False},
    "Toronto Raptors": {"Net": -5.2, "Def": False},
    "Charlotte Hornets": {"Net": -6.8, "Def": False},
    "Chicago Bulls": {"Net": -4.2, "Def": False},
    "Washington Wizards": {"Net": -9.5, "Def": False},
    "Detroit Pistons": {"Net": -3.0, "Def": True},
    "Oklahoma City Thunder": {"Net": 9.2, "Def": True},
    "Minnesota Timberwolves": {"Net": 5.8, "Def": True},
    "Denver Nuggets": {"Net": 5.2, "Def": False},
    "Los Angeles Clippers": {"Net": 3.5, "Def": True},
    "Dallas Mavericks": {"Net": 4.8, "Def": False},
    "Phoenix Suns": {"Net": 3.0, "Def": False},
    "Golden State Warriors": {"Net": 6.5, "Def": True},
    "Sacramento Kings": {"Net": 1.5, "Def": False},
    "Los Angeles Lakers": {"Net": 0.8, "Def": False},
    "Houston Rockets": {"Net": 5.5, "Def": True},
    "Memphis Grizzlies": {"Net": 3.2, "Def": True},
    "New Orleans Pelicans": {"Net": -2.5, "Def": False},
    "San Antonio Spurs": {"Net": -1.5, "Def": True},
    "Utah Jazz": {"Net": -7.5, "Def": False},
    "Portland Trail Blazers": {"Net": -8.0, "Def": False}
}
...
def mc_simulate_spread(home_team, away_team, pt, is_home_pick, team_power):
    h_net = get_net_rating(home_team, team_power)
    a_net = get_net_rating(away_team, team_power)
